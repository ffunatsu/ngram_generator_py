...
def write_ngram(word, n):
    ...
    write_file(ngram_json(word, n), os.path.normpath(f"{dirname}/../etc/roman-gram-{n}.json"), f"{n}-gram")
...
def main():
    ...
    parser.add_argument('-f','--file', default=os.path.normpath(f"{dirname}/../etc/roman.txt"), help='file')
    ...
    write_ngram(content, 4)
    write_ngram(content, 5)
